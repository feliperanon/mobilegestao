    ...
    <Container>
      ...
      <Box component="form" onSubmit={handleSubmit} sx={{ mb: 4, display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: 2 }}>
        <Autocomplete
          ...
          renderInput={(params) => <TextField {...params} label="Entregador" fullWidth required margin="normal" sx={{ flex: 2 }} />}
        />
        <Autocomplete
          multiple
          options={clientes}
          ...
          renderInput={(params) => <TextField {...params} label="Cliente" fullWidth required margin="normal" sx={{ flex: 2 }} />}
        />
        <Autocomplete
          options={statusList}
          getOptionLabel={(option) => option.nome}
          ...
          renderInput={(params) => <TextField {...params} label="Status" fullWidth required margin="normal" sx={{ flex: 1 }} />}
        />
        <TextField
          label="Volume"
          type="number"
      ...
      <Dialog open={editDialogOpen} onClose={closeEditDialog}>
        ...
        <DialogContent>
          ...
          <Autocomplete
            ...
            renderInput={(params) => <TextField {...params} label="Entregador" fullWidth required margin="normal" />}
          />
        </DialogContent>
        <DialogActions>
