      ...
      <Box sx={{ mb: 4 }}>
        ...
        <TableContainer component={Paper}>
          <Table>
            ...
            <TableBody>
              {sortedEntries(metrics.clientVolumes).map(([cliente, volume]) => (
                <TableRow key={cliente}>
                  <TableCell>{cliente}</TableCell>
                  <TableCell>{volume}</TableCell>
                </TableRow>
              ...
              <TableRow>
                <TableCell><strong>Total</strong></TableCell>
                <TableCell><strong>{totalSum(metrics.clientVolumes)}</strong></TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </TableContainer>
        <Bar data={createChartData(metrics.clientVolumes, 'Volume Total')} />
      </Box>
    </Container>
  );
};
