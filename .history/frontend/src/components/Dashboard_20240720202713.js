...
const Dashboard = () => {
  ...
  return (
    <Container>
      ...
      <Box component="form" onSubmit={handleSubmit} sx={{ mb: 6, display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: 2 }}>
        <Autocomplete
        ...
        <TextField
          ...
          sx={{ flex: 1 }}
        />
        <Button type="submit" variant="contained" color="primary" sx={{ mt: 4, flexBasis: '20%' }}>
          Adicionar Entrega
        </Button>
      </Box>
