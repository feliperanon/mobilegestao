...
import Dashboard from './Dashboard';  // Importe o componente Dashboard
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {getSortedEntries(metrics.idleTimes).map(([entregador, idleTime]) => (
                  ...
                  <TableRow>
                    ...
                    <TableCell>{formatTime(getTotal(metrics.idleTimes))}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {getSortedEntries(metrics.deliveryCounts).map(([entregador, count]) => (
                    <TableRow key={entregador}>
                      <TableCell>{entregador}</TableCell>
                  ...
                  <TableRow>
                    <TableCell>Total</TableCell>
                    <TableCell>{getTotal(metrics.deliveryCounts)}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {getSortedEntries(metrics.volumeCounts).map(([entregador, volume]) => (
                    <TableRow key={entregador}>
                      <TableCell>{entregador}</TableCell>
                  ...
                  <TableRow>
                    <TableCell>Total</TableCell>
                    <TableCell>{getTotal(metrics.volumeCounts)}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {getSortedEntries(metrics.totalTimes).map(([entregador, totalTime]) => (
                    <TableRow key={entregador}>
                      <TableCell>{entregador}</TableCell>
                  ...
                  <TableRow>
                    <TableCell>Total</TableCell>
                    <TableCell>{formatTime(getTotal(metrics.totalTimes))}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {getSortedEntries(metrics.clientDeliveryCounts).map(([cliente, count]) => (
                  ...
                  <TableRow>
                    <TableCell>Total</TableCell>
                    <TableCell>{getTotal(metrics.clientDeliveryCounts)}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {getSortedEntries(metrics.clientTimePerVolume).map(([cliente, timePerVolume]) => (
                    <TableRow key={cliente}>
                      <TableCell>{cliente}</TableCell>
                  ...
                  <TableRow>
                    <TableCell>Total</TableCell>
                    <TableCell>{formatTime(getTotal(metrics.clientTimePerVolume))}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {getSortedEntries(metrics.clientTotalTimes).map(([cliente, totalTime]) => (
                    <TableRow key={cliente}>
                      <TableCell>{cliente}</TableCell>
                      <TableCell>{formatTime(totalTime)}</TableCell>
                    </TableRow>
                  ...
                  <TableRow>
                    <TableCell>Total</TableCell>
                    <TableCell>{formatTime(getTotal(metrics.clientTotalTimes))}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <TableContainer component={Paper}>
              <Table>
                ...
                <TableBody>
                  {getSortedEntries(metrics.clientVolumes).map(([cliente, volume]) => (
                    <TableRow key={cliente}>
                      <TableCell>{cliente}</TableCell>
                      <TableCell>{volume}</TableCell>
                    </TableRow>
                  ...
                  <TableRow>
                    <TableCell>Total</TableCell>
                    <TableCell>{getTotal(metrics.clientVolumes)}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
