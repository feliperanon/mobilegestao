    ...
    <Container>
      ...
      <Box component="form" onSubmit={handleSubmit} sx={{ mb: 4, display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: 2 }}>
        <Autocomplete
          ...
          renderInput={(params) => <TextField {...params} label="Entregador" required margin="normal" sx={{ flex: 1 }} />}
        />
        <Autocomplete
          options={clientes}
          getOptionLabel={(option) => option.nome}
          ...
          renderInput={(params) => <TextField {...params} label="Cliente" required margin="normal" sx={{ flex: 1 }} />}
        />
        <Autocomplete
          options={statusList}
          getOptionLabel={(option) => option.nome}
          ...
          renderInput={(params) => <TextField {...params} label="Status" required margin="normal" sx={{ flex: 1 }} />}
        />
        <TextField
          label="Volume"
          type="number"
      ...
      <Dialog open={editDialogOpen} onClose={closeEditDialog}>
        ...
        <DialogContent>
          ...
          <Autocomplete
            ...
            renderInput={(params) => <TextField {...params} label="Entregador" required margin="normal" />}
          />
        </DialogContent>
        <DialogActions>
